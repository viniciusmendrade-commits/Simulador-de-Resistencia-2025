...
import { LinearSystemExplanation } from './LinearSystemExplanation';
...
const tutorialSteps: TutorialStep[] = [
    ...
    {
        text: "Esta é a barra de 'Resistencia Estrutural'. Após um desastre, ela mostrará a saúde geral do seu edifício. Tente mantê-la o mais verde possível!",
    ...
    {
        text: "Para calcular os danos, o jogo usa matemática! Veja um exemplo de como as forças são distribuídas em sua estrutura usando um sistema linear.",
        ...
        <div className="fixed inset-0 z-50 animate-[fade-in_0.5s_ease-in-out]" onClick={handleNext}>
            ...
            <div className="absolute bottom-4 left-4 sm:bottom-10 sm:left-10 flex items-end gap-4 max-w-lg w-[calc(100%-2rem)] sm:w-auto animate-[slide-up-fade_0.5s_ease-out]">
                 ...
                 <div className="relative bg-white text-slate-800 p-4 rounded-lg rounded-bl-none shadow-2xl">
                     ...
                     {currentStep.showExplanation && <LinearSystemExplanation />}
